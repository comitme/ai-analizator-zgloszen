# Ewaluacja klasyfikatora — `claude-haiku-4-5`

- Tryb: **live**
- Wersja zbioru: 1 · powtórzenia: 1 · wierszy: 40
- Uruchomiono: 2026-09-11 11:08 UTC
...
Każdy wiersz zbioru testowego (`eval/dataset/tickets.jsonl`) to jedno zgłoszenie klienta z ręcznie ustaloną poprawną intencją i, jeśli dotyczy, numerem zamówienia. Ten raport porównuje odpowiedzi modelu `claude-haiku-4-5` z tymi etykietami — bez żadnej generacji odpowiedzi, wyłącznie klasyfikacja.
...
| 0.00 – 0.50 | 0 | — | — |
| 0.50 – 0.75 | 0 | — | — |
| 0.75 – 0.90 | 5 | 100.0% | 83.0% |
| 0.90 – 1.00 | 35 | 100.0% | 94.8% |

Expected Calibration Error: **6.7%** (0% = idealna kalibracja).

## Koszt i wydajność

| | Wartość |
|---|---|
| Tokeny wejścia / wyjścia | 59,133 / 3,320 |
| Tokeny na wiersz (min / mediana / max) | 1520 / 1559 / 1605 |
| Koszt całego przebiegu | $0.0757 (0.3067 zł) |
| Koszt na zgłoszenie | $0.001893 |
| Latencja p50 / p95 | 2835 ms / 3473 ms |
